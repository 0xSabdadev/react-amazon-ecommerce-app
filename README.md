...
```
git clone https://github.com/0xSabdadev/react-amazon-ecommerce-app
```
```
git clone git@github.com:0xSabdadev/react-amazon-ecommerce-app
```
```
cd react-amazon-ecommerce-app
```
```
npm install
```
